...
public class PerformanceGetMines extends BaseTestClass{
    ...
    public void PerformanceGetMines_WithRandomAmounts1() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/GetMines/get.0.txt");
        ...
        File result = new File("src/pitFortress/tests/Results/GetMines/get.0.result.txt");
    ...
    public void PerformanceGetMines_WithRandomAmounts2() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/GetMines/get.1.txt");
        Scanner scanner = new Scanner(file);
        ArrayList<String[]> commands = new ArrayList<>();
        while (scanner.hasNextLine()) {
            commands.add(scanner.nextLine().split(" "));
        ...
        File result = new File("src/pitFortress/tests/Results/GetMines/get.1.result.txt");
        Scanner resultReader = new Scanner(result);
    ...
    public void PerformanceGetMines_WithRandomAmounts3() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/GetMines/get.2.txt");
        Scanner scanner = new Scanner(file);
        ArrayList<String[]> commands = new ArrayList<>();
        while (scanner.hasNextLine()) {
            commands.add(scanner.nextLine().split(" "));
        ...
        File result = new File("src/pitFortress/tests/Results/GetMines/get.2.result.txt");
        Scanner resultReader = new Scanner(result);
    ...
    public void PerformanceGetMines_WithRandomAmounts4() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/GetMines/get.3.txt");
        Scanner scanner = new Scanner(file);
        ArrayList<String[]> commands = new ArrayList<>();
        while (scanner.hasNextLine()) {
            commands.add(scanner.nextLine().split(" "));
        ...
        File result = new File("src/pitFortress/tests/Results/GetMines/get.3.result.txt");
        Scanner resultReader = new Scanner(result);
    ...
    public void PerformanceGetMines_WithRandomAmounts5() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/GetMines/get.4.txt");
        Scanner scanner = new Scanner(file);
        ArrayList<String[]> commands = new ArrayList<>();
        while (scanner.hasNextLine()) {
            commands.add(scanner.nextLine().split(" "));
        ...
        File result = new File("src/pitFortress/tests/Results/GetMines/get.4.result.txt");
        Scanner resultReader = new Scanner(result);
