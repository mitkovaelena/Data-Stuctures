...
public class PerformanceSetMine extends BaseTestClass{
    ...
    public void PerformanceSetMine_WithRandomAmounts1() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/SetMine/mine.0.txt");
        ...
        File result = new File("src/pitFortress/tests/Results/SetMine/mine.0.result.txt");
    ...
    public void PerformanceSetMine_WithRandomAmounts2() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/SetMine/mine.1.txt");
        Scanner scanner = new Scanner(file);
        ArrayList<String[]> commands = new ArrayList<>();
        while (scanner.hasNextLine()) {
            commands.add(scanner.nextLine().split(" "));
        ...
        File result = new File("src/pitFortress/tests/Results/SetMine/mine.1.result.txt");
        Scanner resultReader = new Scanner(result);
    ...
    public void PerformanceSetMine_WithRandomAmounts3() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/SetMine/mine.2.txt");
        Scanner scanner = new Scanner(file);
        ArrayList<String[]> commands = new ArrayList<>();
        while (scanner.hasNextLine()) {
            commands.add(scanner.nextLine().split(" "));
        ...
        File result = new File("src/pitFortress/tests/Results/SetMine/mine.2.result.txt");
        Scanner resultReader = new Scanner(result);
    ...
    public void PerformanceSetMine_WithRandomAmounts4() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/SetMine/mine.3.txt");
        Scanner scanner = new Scanner(file);
        ArrayList<String[]> commands = new ArrayList<>();
        while (scanner.hasNextLine()) {
            commands.add(scanner.nextLine().split(" "));
        ...
        File result = new File("src/pitFortress/tests/Results/SetMine/mine.3.result.txt");
        Scanner resultReader = new Scanner(result);
    ...
    public void PerformanceSetMine_WithRandomAmounts5() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/SetMine/mine.4.txt");
        Scanner scanner = new Scanner(file);
        ArrayList<String[]> commands = new ArrayList<>();
        while (scanner.hasNextLine()) {
            commands.add(scanner.nextLine().split(" "));
        ...
        File result = new File("src/pitFortress/tests/Results/SetMine/mine.4.result.txt");
        Scanner resultReader = new Scanner(result);
