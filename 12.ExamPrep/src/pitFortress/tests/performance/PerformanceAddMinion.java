...
public class PerformanceAddMinion extends BaseTestClass {
    ...
    public void PerformanceAddMinion_WithRandomAmounts1() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/AddMinion/addMinion.0.txt");
        ...
        File result = new File("src/pitFortress/tests/Results/AddMinion/addMinion.0.result.txt");
    ...
    public void PerformanceAddMinion_WithRandomAmounts2() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/AddMinion/addMinion.1.txt");
        Scanner scanner = new Scanner(file);
        ArrayList<Integer> commands = new ArrayList<>();
        while (scanner.hasNextLine()) {
            commands.add(Integer.parseInt(scanner.nextLine()));
        ...
        File result = new File("src/pitFortress/tests/Results/AddMinion/addMinion.1.result.txt");
        Scanner resultReader = new Scanner(result);
    ...
    public void PerformanceAddMinion_WithRandomAmounts3() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/AddMinion/addMinion.2.txt");
        Scanner scanner = new Scanner(file);
        ArrayList<Integer> commands = new ArrayList<>();
        while (scanner.hasNextLine()) {
            commands.add(Integer.parseInt(scanner.nextLine()));
        ...
        File result = new File("src/pitFortress/tests/Results/AddMinion/addMinion.2.result.txt");
        Scanner resultReader = new Scanner(result);
    ...
    public void PerformanceAddMinion_WithRandomAmounts4() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/AddMinion/addMinion.3.txt");
        Scanner scanner = new Scanner(file);
        ArrayList<Integer> commands = new ArrayList<>();
        while (scanner.hasNextLine()) {
            commands.add(Integer.parseInt(scanner.nextLine()));
        ...
        File result = new File("src/pitFortress/tests/Results/AddMinion/addMinion.3.result.txt");
        Scanner resultReader = new Scanner(result);
    ...
    public void PerformanceAddMinion_WithRandomAmounts5() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/AddMinion/addMinion.4.txt");
        Scanner scanner = new Scanner(file);
        ArrayList<Integer> commands = new ArrayList<>();
        while (scanner.hasNextLine()) {
            commands.add(Integer.parseInt(scanner.nextLine()));
        ...
        File result = new File("src/pitFortress/tests/Results/AddMinion/addMinion.4.result.txt");
        Scanner resultReader = new Scanner(result);
