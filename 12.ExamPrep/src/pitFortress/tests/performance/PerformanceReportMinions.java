package pitFortress.tests.performance;

import pitFortress.main.models.Minion;
import org.junit.Assert;
import org.junit.Test;
import org.junit.experimental.categories.Category;
import pitFortress.tests.BaseTestClass;
import pitFortress.tests.categories.Performance;
...
public class PerformanceReportMinions extends BaseTestClass{
    ...
    public void PerformanceReportMinions_WithRandomAmounts1() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/ReportMinions/report.0.txt");
        ...
        File result = new File("src/pitFortress/tests/Results/ReportMinions/report.0.result.txt");
    ...
    public void PerformanceReportMinions_WithRandomAmounts2() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/ReportMinions/report.1.txt");
        Scanner scanner = new Scanner(file);
        ArrayList<Integer> commands = new ArrayList<>();
        while (scanner.hasNextLine()) {
            commands.add(Integer.parseInt(scanner.nextLine()));
        ...
        File result = new File("src/pitFortress/tests/Results/ReportMinions/report.1.result.txt");
        Scanner resultReader = new Scanner(result);
    ...
    public void PerformanceReportMinions_WithRandomAmounts3() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/ReportMinions/report.2.txt");
        Scanner scanner = new Scanner(file);
        ArrayList<Integer> commands = new ArrayList<>();
        while (scanner.hasNextLine()) {
            commands.add(Integer.parseInt(scanner.nextLine()));
        ...
        File result = new File("src/pitFortress/tests/Results/ReportMinions/report.2.result.txt");
        Scanner resultReader = new Scanner(result);
    ...
    public void PerformanceReportMinions_WithRandomAmounts4() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/ReportMinions/report.3.txt");
        Scanner scanner = new Scanner(file);
        ArrayList<Integer> commands = new ArrayList<>();
        while (scanner.hasNextLine()) {
            commands.add(Integer.parseInt(scanner.nextLine()));
        ...
        File result = new File("src/pitFortress/tests/Results/ReportMinions/report.3.result.txt");
        Scanner resultReader = new Scanner(result);
    ...
    public void PerformanceReportMinions_WithRandomAmounts5() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/ReportMinions/report.4.txt");
        Scanner scanner = new Scanner(file);
        ArrayList<Integer> commands = new ArrayList<>();
        while (scanner.hasNextLine()) {
            commands.add(Integer.parseInt(scanner.nextLine()));
        ...
        File result = new File("src/pitFortress/tests/Results/ReportMinions/report.4.result.txt");
        Scanner resultReader = new Scanner(result);
