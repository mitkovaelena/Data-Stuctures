...
public class PerformanceMin3Players extends BaseTestClass{
    ...
    public void PerformanceMin3Players_WithRandomAmounts1() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/Min3Players/min3.0.txt");
        ...
        File result = new File("src/pitFortress/tests/Results/Min3Players/min3.0.result.txt");
    ...
    public void PerformanceMin3Players_WithRandomAmounts2() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/Min3Players/min3.1.txt");
        Scanner scanner = new Scanner(file);
        ArrayList<String[]> commands = new ArrayList<>();
        while (scanner.hasNextLine()) {
            commands.add(scanner.nextLine().split(" "));
        ...
        File result = new File("src/pitFortress/tests/Results/Min3Players/min3.1.result.txt");
        Scanner resultReader = new Scanner(result);
    ...
    public void PerformanceMin3Players_WithRandomAmounts3() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/Min3Players/min3.2.txt");
        Scanner scanner = new Scanner(file);
        ArrayList<String[]> commands = new ArrayList<>();
        while (scanner.hasNextLine()) {
            commands.add(scanner.nextLine().split(" "));
        ...
        File result = new File("src/pitFortress/tests/Results/Min3Players/min3.2.result.txt");
        Scanner resultReader = new Scanner(result);
    ...
    public void PerformanceMin3Players_WithRandomAmounts4() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/Min3Players/min3.3.txt");
        Scanner scanner = new Scanner(file);
        ArrayList<String[]> commands = new ArrayList<>();
        while (scanner.hasNextLine()) {
            commands.add(scanner.nextLine().split(" "));
        ...
        File result = new File("src/pitFortress/tests/Results/Min3Players/min3.3.result.txt");
        Scanner resultReader = new Scanner(result);
    ...
    public void PerformanceMin3Players_WithRandomAmounts5() throws FileNotFoundException, IOException {
        File file = new File("src/pitFortress/tests/Tests/Min3Players/min3.4.txt");
        Scanner scanner = new Scanner(file);
        ArrayList<String[]> commands = new ArrayList<>();
        while (scanner.hasNextLine()) {
            commands.add(scanner.nextLine().split(" "));
        ...
        File result = new File("src/pitFortress/tests/Results/Min3Players/min3.4.result.txt");
        Scanner resultReader = new Scanner(result);
